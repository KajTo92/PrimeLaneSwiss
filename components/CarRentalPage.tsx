  ...
  const rentalCars = [
    {
      ...
      price: language === "de" ? "799 CHF" : "CHF 799",
      priceSuffix: language === "de" ? "Monat" : "month",
      conditions: [
        {
          type: "calendar" as const,
          title: language === "de" ? "Gewerblich – 1'099 CHF" : "Commercial use – CHF 1,099",
          description: language === "de" ? "Pro Monat" : "Per month",
        },
        {
          type: "calendar" as const,
          title: language === "de" ? "Privat – 799 CHF" : "Private – CHF 799",
          description: language === "de" ? "Pro Monat" : "Per month",
        },
        {
          type: "clock" as const,
          title: language === "de" ? "Privat – 250 CHF" : "Private – CHF 250",
          description: language === "de" ? "Pro Woche" : "Per week",
        },
      ],
      inquiryDetails:
        language === "de"
          ? "Gewerblich: 1'099 CHF / Monat\nPrivat: 799 CHF / Monat\nPrivat: 250 CHF / Woche"
          : "Commercial use: CHF 1,099 / month\nPrivate: CHF 799 / month\nPrivate: CHF 250 / week",
    },
    {
      ...
      conditions: [
        {
          type: "calendar" as const,
          title: language === "de" ? "Privatvermietung – 250 CHF" : "Private rental – CHF 250",
          description: language === "de" ? "Pro Woche" : "Per week",
        },
        {
          type: "calendar" as const,
          title: language === "de" ? "Privatvermietung – 799 CHF" : "Private rental – CHF 799",
          description: language === "de" ? "Pro Monat" : "Per month",
        },
        {
          type: "clock" as const,
      ...
      inquiryDetails:
        language === "de"
          ? "Preis: 1'099 CHF / Monat\nPrivatvermietung: 250 CHF / Woche\nPrivatvermietung: 799 CHF / Monat\nKaution: 1'000 CHF\nKilometer: Unbegrenzt\nMindestmietdauer: 1 Monat"
          : "Price: CHF 1,099 / month\nPrivate rental: CHF 250 / week\nPrivate rental: CHF 799 / month\nDeposit: CHF 1,000\nMileage: Unlimited\nMinimum rental period: 1 month",
    },
    {
      id: "tesla-model-s",
      brand: "Tesla",
      ...
      conditions: [
        ...
        {
          type: "calendar" as const,
          title: language === "de" ? "Wochenmiete – 450 CHF" : "Weekly rental – CHF 450",
          description: language === "de" ? "Pro Woche" : "Per week",
        },
        {
          type: "clock" as const,
          title: language === "de" ? "Unbegrenzte Kilometer" : "Unlimited mileage",
          description: language === "de" ? "Fahren ohne Kilometerlimit" : "Drive without a mileage limit",
        },
        {
          type: "deposit" as const,
          title: language === "de" ? "Kaution – 1'000–1'500 CHF" : "Deposit – CHF 1,000–1,500",
          description: language === "de" ? "Rückzahlbare Kaution" : "Refundable deposit",
        },
      ],
      inquiryDetails:
        language === "de"
          ? "Monatspreis: 1'999 CHF\nWochenpreis: 450 CHF\nKaution: 1'000–1'500 CHF\nKilometer: Unbegrenzt\nLaden: Kostenlos"
          : "Monthly price: CHF 1,999\nWeekly price: CHF 450\nDeposit: CHF 1,000–1,500\nMileage: Unlimited\nCharging: Free",
    },
    {
      id: "peugeot-boxer",
      brand: "Peugeot",
