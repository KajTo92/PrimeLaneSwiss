...
export function TestimonialsCarousel({ language }: TestimonialsCarouselProps) {
  ...
  return (
    <div className="mt-8 overflow-hidden rounded-[1.7rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] py-5 shadow-[0_0_50px_rgba(255,255,255,0.03)]">
      ...
      <div className="relative h-[380px] overflow-hidden sm:h-auto">
        <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-10 bg-gradient-to-b from-[#0b0b0d] to-transparent sm:hidden" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-10 bg-gradient-to-t from-[#0b0b0d] to-transparent sm:hidden" />
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 hidden w-10 bg-gradient-to-r from-[#0b0b0d] to-transparent sm:block" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 hidden w-10 bg-gradient-to-l from-[#0b0b0d] to-transparent sm:block" />

        <motion.div
          className="flex flex-col gap-4 px-5 sm:hidden"
          animate={{ y: ["0%", "-50%"] }}
        ...
        >
          {duplicatedTestimonials.map((review, index) => (
            <article
              ...
              className="w-full shrink-0 rounded-[1.5rem] border border-white/10 bg-black/28 p-4"
            >
        ...
        <motion.div
          className="hidden w-max gap-4 px-5 sm:flex sm:px-6"
          animate={{ x: ["0%", "-50%"] }}
