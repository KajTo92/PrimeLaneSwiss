...
export default function Home() {
  const companyPhoneDisplay = "+41 00 000 00 00";
  const companyPhoneHref = "tel:+410000000000";
    ...
    <main className="bg-[#050506] text-white">
      <section className="fixed top-0 left-0 right-0 z-30 border-b border-white/10 bg-black/45 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <a href="#hero" className="text-m tracking-[0.2em] text-white/90">
             <span className="gold-text">PRIME LANE</span> SWISS
          </a>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="#booking" className="btn-premium text-xs">
